 ...
 * Describe   pop中的textview和editview无法选择复制，这个类被废弃了
 */


public class FollowHintPop extends PopupWindow implements View.OnClickListener {

    private Activity mContext;

    public FollowHintPop(Context context) {
        super(context);
    ...
    private void initView() {
        View view = View.inflate(mContext, R.layout.pop_cash_hint, null);
...
//        this.setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        ...
        this.setOnDismissListener(new FollowHintPop.poponDismissListener());
