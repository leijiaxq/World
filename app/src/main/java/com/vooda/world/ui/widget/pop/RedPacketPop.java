...
public class RedPacketPop extends PopupWindow implements View.OnClickListener {
    ...
    private void initView() {
        View view = View.inflate(mContext, R.layout.pop_red_packet, null);
...
//        ColorDrawable colorDrawable = new ColorDrawable(0x00000000);
        ...
        this.setOnDismissListener(new RedPacketPop.poponDismissListener());
