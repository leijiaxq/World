package com.vooda.world.ui.widget;
...
public class WheelView extends View {
    ...
    private class ItemObject {
        ...
        public boolean isSelected() {
            if ((y + move) >= controlHeight / 2 - unitHeight / 2 + lineHeight*2
                    && (y + move) <= controlHeight / 2 + unitHeight / 2 - lineHeight*2) {
                return true;
            }
            if ((y + move + unitHeight) >= controlHeight / 2 - unitHeight / 2 + lineHeight*2
                    && (y + move + unitHeight) <= controlHeight / 2 + unitHeight / 2 - lineHeight*2) {
                return true;
            }
            if ((y + move) <= controlHeight / 2 - unitHeight / 2 + lineHeight*2
                    && (y + move + unitHeight) >= controlHeight / 2 + unitHeight / 2 - lineHeight*2) {
